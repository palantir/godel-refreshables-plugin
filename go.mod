...
require (
	...
	github.com/palantir/conjure-go-runtime/v2 v2.34.0
...
require (
	...
	github.com/palantir/witchcraft-go-error v1.9.0 // indirect
	github.com/palantir/witchcraft-go-logging v1.24.0 // indirect
