...
require (
	...
	github.com/palantir/witchcraft-go-error v1.20.0 // indirect
	github.com/palantir/witchcraft-go-logging v1.35.0 // indirect
	github.com/palantir/witchcraft-go-params v1.17.0 // indirect
	github.com/palantir/witchcraft-go-tracing v1.19.0 // indirect
